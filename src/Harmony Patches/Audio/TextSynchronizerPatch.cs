...
namespace IAmYourTranslator.Patches
{
    ...
    public static class TextSynchronizerPatch
    {
        ...
        public static void RefreshAllSynchronizers()
        {
            try
            {
                ...
                foreach (var sync in synchronizers)
                {
                    ...
                    ApplyFontToAllChildrenTMP(sync, TMPFontReplacer.GetCachedFont(Plugin.GlobalFontPath), "[TextSynchronizer]");
                }
            }
            catch (Exception e)
            {
        ...
        public static void OnTimingsSet_Postfix(TextSynchronizer __instance, PhraseAsset value)
        {
            ...
            ApplyFontToAllChildrenTMP(__instance, TMPFontReplacer.GetCachedFont(Plugin.GlobalFontPath), "[TextSynchronizer]");
